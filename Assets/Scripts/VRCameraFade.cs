...
namespace VRStandardAssets.Utils
{
    ...
    public class VRCameraFade : MonoBehaviour
    {
        ...
        [SerializeField] private Image m_FadeImage = null;                      // Reference to the image that covers the screen.
        [SerializeField] private AudioMixerSnapshot m_DefaultSnapshot = null;   // Settings for the audio mixer to use normally.
        [SerializeField] private AudioMixerSnapshot m_FadedSnapshot = null;     // Settings for the audio mixer to use when faded out.
		...
		[SerializeField] private float teleportDuration = 1.0f;                 // How long it takes to fade in seconds.
